...
async function estimate(tx, organizationId) {
    ...
    const estimateEligible = organization.status === "ACTIVE" && profile.status !== "CLOSED";
...
export const billing = {
    ...
    async setStatus(actorId, organizationId, status) {
    ...
    async summary(actorId) {
        ...
        return transaction(async (tx) => {
            ...
            return {
                ...
                organizationCount,
                billableMemberCount,
                estimatedMonthlyMinor: organizationCount * BASE_PRICE_MINOR +
