...
export const platform = {
    ...
    async organizations(actorId, query) {
        await requireOperator(actorId);
        return transaction(async (tx) => {
    ...
    async setUserStatus(actorId, id, status) {
    ...
    async setOrganizationStatus(actorId, id, status) {
        await requireOperator(actorId, true);
        return transaction(async (tx) => {
